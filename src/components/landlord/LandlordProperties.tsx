              ...
              <div className="p-4 space-y-3 flex-1 flex flex-col justify-between">
                ...
                <div className="pt-2.5 border-t border-slate-800/80">
                  <button
                    ...
                    className="w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-black text-xs transition-all duration-200 flex items-center justify-center gap-2 shadow-[0_0_18px_rgba(0,242,254,0.25)] hover:shadow-[0_0_28px_rgba(0,242,254,0.45)] active:scale-95 group/view cursor-pointer"
